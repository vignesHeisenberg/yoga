                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <!-- page-scroll -->
                                        <!-- <a class="" href="#">Our Services   <span class="caret"></span></a> -->
                                        ...
                                        <div class="dropdown page-scroll">
                                            ...
                                            <ul class="dropdown-menu " aria-labelledby="dropdownMenu1">
                                              ...
                                              <!-- <li><a href="./kids-yoga.php">Kids yoga</a></li> -->
                                              <li><a href="./detox-diet.php">Detox Diet</a></li>
                                              <!-- <li><a href="./personalised-diet.php">Personalised-Diet</a></li> -->
                                              <!-- <li><a href="./FAMILY DIET.php">PCOS Diet</a></li> -->
                                              
                                              <!-- <li><a href="./KNOW YOUR BODY TYPE.php">Know your body type</a></li>                                            -->
                                            </ul
                                          </div>
                                    </li>
                                    <!-- <li class="nav-item">
                                        <a class="page-scroll" href="bws.php">Beautiful Women series</a>
                                    </li> -->
                                    <li class="nav-item">
